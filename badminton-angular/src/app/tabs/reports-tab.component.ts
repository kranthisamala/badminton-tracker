...
@Component({
  ...
  styleUrls: ['./reports-tab.component.less']
})
export class ReportsTabComponent implements AfterViewInit, DoCheck, OnDestroy {
  ...
  @Output() drilldown = new EventEmitter<ReportsDrilldown>();
